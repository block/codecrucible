...
var defaultModels = []ModelConfig{
	...
	},
	{
		...
		ExecutionWarning:         "claude-fable-5 may trigger security-policy errors during security analysis and may require Anthropic workspace data retention access; provider rejection invalidates scan results",
		InputPricePerM:           10.0,
